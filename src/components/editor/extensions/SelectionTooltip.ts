...
import { showQuickEditEffect,quickEditState } from './quickEdit';
    ...
    return [
        {
            ...
            create(){
                ...
                addToChatButton.className="font-sans p-1 px-2 hover:bg-foreground/10 rounded-sm flex items-center gap-1"
